package com.yu.hu.ppjoke.exoplayer;
...
public class PageListPlayDetector {
    ...
    Runnable delayAutoPlay = this::autoPlay;
    ...
    private boolean isTargetInBounds(IPlayTarget target) {
        ...
        owner.getLocationOnScreen(loacation);

        int center = loacation[1] + owner.getHeight() / 2;
